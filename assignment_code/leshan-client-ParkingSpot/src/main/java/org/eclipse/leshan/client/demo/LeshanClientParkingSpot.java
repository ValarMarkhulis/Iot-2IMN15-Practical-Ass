...
public class LeshanClientParkingSpot {

    private static final Logger LOG = LoggerFactory.getLogger(LeshanClientParkingSpot.class);
    ...
    public static void createAndStartClient(String endpoint, String localAddress, int localPort, boolean needBootstrap,
            ...
            Float latitude, Float longitude, float scaleFactor) throws CertificateEncodingException, IOException {
